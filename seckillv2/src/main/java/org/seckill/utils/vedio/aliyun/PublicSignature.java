...
//        System.out.println("signature---" + signature);
    ...
    public static String generateSignString(String httpMethod,
        ...
        String canonicalizeQueryString = UrlUtil.generateQueryString(
                sortParameter, true);
        if (null == httpMethod) {
        ...
        stringToSign.append(percentEncode(canonicalizeQueryString));
    ...
    public static String composeStringToSign(Map<String, String> queries) {
        ...
        String[] sortedKeys = strings.toArray(new String[strings.size()]);
        Arrays.sort(sortedKeys);
        StringBuilder canonicalizeQueryString = new StringBuilder();
        for (String key : sortedKeys) {
            canonicalizeQueryString.append("&").append(percentEncode(key))
                    .append("=")
        ...
        stringToSign.append("&");
        stringToSign.append(percentEncode(canonicalizeQueryString.toString()
                .substring(1)));
