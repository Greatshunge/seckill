...
//					'<a style="height: ' + this.options.headerHeight + this.options.cssUnit + '; line-height: ' + this.options.headerHeight + this.options.cssUnit + '" href="../注册资料填写.html" class="close">上一步</a>',
//					'<a style="height: ' + this.options.headerHeight + this.options.cssUnit + '; line-height: ' + this.options.headerHeight + this.options.cssUnit + '" href="学历.html" class="sure suraba shure-sexshow">确定</a>',
//				'</header>',
